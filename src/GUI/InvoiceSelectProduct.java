 ...
 * @author User
 */
public class InvoiceSelectProduct extends javax.swing.JFrame {
     ...
     */
    public InvoiceSelectProduct(Invoice invoice, InvoiceItem invoiceItem) {
    ...
    private void styleTheTextFieldsAndButtons() {
        ...
        jTextField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Search by Product ID");
    ...
    private void loadProducts() {
        ...
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `product` ORDER BY `id` ASC");
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" Seach by Product ID :-");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            invoiceItem.setProduct_id(String.valueOf(jTable1.getValueAt(row, 0)));
            invoiceItem.setProduct_name(String.valueOf(jTable1.getValueAt(row, 1)));
            invoiceItem.setProduct_price(Double.parseDouble(String.valueOf(jTable1.getValueAt(row, 2))));
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (searchValue.isEmpty()) {
            ...
            try {
                ...
                ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `product` WHERE `id` LIKE '%" + searchValue + "%' ORDER BY `id` ASC");
