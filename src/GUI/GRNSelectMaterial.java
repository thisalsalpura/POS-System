 ...
 * @author User
 */
public class GRNSelectMaterial extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GRNSelectMaterial
     */
    public GRNSelectMaterial(GRN grn, GRNItem grnItem) {
        this.grn = grn;
    ...
    private void styleTheTextFieldsAndButtons() {
        ...
        jTextField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Search by Material ID");
    ...
    private void loadMaterials() {
        ...
        try {
            ...
            ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `material` ORDER BY `id` ASC");
            ...
            e.printStackTrace();
            logger.log(Level.WARNING, "Load Material Error!", e);
        } catch (Exception e) {
            e.printStackTrace();
            logger.log(Level.WARNING, "Load Material Error!", e);
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText(" Seach by Material ID :-");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            ...
            grnItem.setMaterial_id(String.valueOf(jTable1.getValueAt(row, 0)));
            grnItem.setMaterial_name(String.valueOf(jTable1.getValueAt(row, 1)));

            grn.setMaterialsDetails();
    ...
    private void jTextField1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyReleased
        ...
        if (searchValue.isEmpty()) {
            ...
            try {
                ...
                ResultSet resultSet = MySQL.executeSearch("SELECT * FROM `material` WHERE `id` LIKE '%" + searchValue + "%' ORDER BY `id` ASC");
                ...
                e.printStackTrace();
                logger.log(Level.WARNING, "Error in the Material Selection Process!", e);
            } catch (Exception e) {
                e.printStackTrace();
                logger.log(Level.WARNING, "Error in the Material Selection Process!", e);
            }
